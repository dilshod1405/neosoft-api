...
from .views import StudentCourseDetailView, StudentCourseListView, SubmitAnswerView, StudentCategoryTreeView, VdoCipherOTPView
...
urlpatterns = [
    ...
    path('vdocipher/otp/<str:video_id>/', VdoCipherOTPView.as_view(), name='generate-otp'),
]
