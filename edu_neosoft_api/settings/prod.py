...
MULTICARD_STORE_ID = int(config("MULTICARD_STORE_ID"))
MULTICARD_API_URL = config("MULTICARD_API_URL")
MULTICARD_API_KEY = config("MULTICARD_API_KEY")
MULTICARD_SANDBOX_OTP = config("MULTICARD_SANDBOX_OTP")
MULTICARD_USE_SANDBOX = config("MULTICARD_USE_SANDBOX")
MULTICARD_APP_ID = config("MULTICARD_APP_ID")
